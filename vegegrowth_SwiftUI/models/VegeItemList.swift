...
struct VegeItemList {
    func getVegeList() -> [VegeItem] {
        return [
            ...
            VegeItem(name: "きゅうり", uuid: UUID().uuidString, category: VegeCategory.other, status: VegeStatus.default),
            ...
            VegeItem(name: "ダリア", uuid: UUID().uuidString, category: VegeCategory.other, status: VegeStatus.default),
            VegeItem(name: "トマト", uuid: UUID().uuidString, category: VegeCategory.leaf, status: VegeStatus.default),
